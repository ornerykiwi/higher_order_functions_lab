...
describe('ScranAdvisor', () => {
    ...
    test('can find Happy Lamb Hot Pot restaurant by full name', () => {
        ...
        const actual = scranAdvisor.restaurantByFullName("Happy Lamb Hot Pot");
        expect(actual).toEqual(expected);
    })
    ...
    test('can find the name of all restaurants', () => {
        const expected = [
          ...
          const actual = scranAdvisor.allRestaurants();
          expect(actual).toEqual(expected);
    })
    ...
    test('can find all restaurants from Glasgow', () => {
        const expected = [
          ...
          const actual = scranAdvisor.allRestaurantsInTown("Glasgow");
          expect(actual).toEqual(expected);
    })
